...
// eslint-disable-next-line import/no-cycle
import { signInWithEmail } from '../lib/firebaseAuth.js';
...
export const Login = () => {
  ...
  btnLogin.addEventListener('click', (e) => {
    ...
    const emailSaved = document.getElementById('email').value;
    // eslint-disable-next-line no-shadow
    const passwordSaved = document.getElementById('password').value;
    signInWithEmail(emailSaved, passwordSaved);
  });
